...
class GraphTheory(Scene):
	def construct(self):
		...
		self.wait(1)
		self.play(FadeOut(t7), FadeOut(t76), FadeOut(t77), FadeOut(t78), FadeOut(t79), FadeOut(my_graph), FadeOut(edge_highlight8), FadeOut(edge_highlight9), FadeOut(edge_highlight10), FadeOut(edge_highlight11), run_time=1)
		...
		self.wait(3)
		self.play(my_graph3.animate.move_to(np.array([0, 1, 0])).scale(0.75), run_time=1)
		self.wait(1)
		t8 = MarkupText(
			f"""
			...
			font="Lucida Console",
			font_size=25
		).next_to(my_graph3, DOWN, buff=0.5)
		t81 = MarkupText(
			f"""
		...
		self.play(Write(t8), run_time=3.5)
		self.play(Write(t81), run_time=2)
		self.wait(2)
		self.play(FadeOut(t8), FadeOut(t81))
		self.play(my_graph3.animate.move_to(np.array([0, 0, 0])).scale(1.5), run_time=1)
		self.wait(3)
		self.play(FadeOut(my_graph3))
		...
		self.play(Create(my_graph4.vertices), run_time=2)
		self.play(Create(my_graph4.edge_lines), run_time=2)
		self.play(my_graph4.animate.move_to(ORIGIN).scale(1.5), run_time=1)
		self.wait(1)
		...
		self.wait(2)
		self.play(graphandhighlight.animate.move_to(UP).scale(0.75), run_time=1)
		t82 = MarkupText(
			f"""
			We can say that the edges connected to a nodes can be split into 2 parts, in-edges and out-edges
			""",
			font="Lucida Console",
			font_size=20
		...
		t83 = MarkupText(
			f"""
			(for every edge you use to enter the node, or to leave it, we can say that these edges come in pairs).
			""",
			font="Lucida Console",
			font_size=20
		...
		t84 = MarkupText(
			...
			font="Lucida Console",
			font_size=20
		).next_to(t83, DOWN, buff=0.2).scale(0.75)
		...
		self.play(FadeOut(graphandhighlight), FadeOut(t82), FadeOut(t83), FadeOut(t84))
		...
		self.play(Create(my_graph5.vertices), run_time=3)
		self.play(Create(my_graph5.edge_lines), run_time=3)
		self.wait(2)
		self.play(my_graph5.animate.move_to(UP), run_time=1)
		...
		self.play(FadeOut(t9), FadeOut(t91))
		...
		self.play(Write(t11), run_time=1)
		self.play(Write(t12), run_time=1)
		self.play(Write(t13), run_time=1)
		self.play(Write(t14), run_time=1)
		self.play(Write(t15), run_time=1)

		schoolg = VGroup(my_graph5, t10, t11, t12, t13, t14, t15)

		self.play(schoolg.animate.move_to(LEFT*3), run_time=1)
